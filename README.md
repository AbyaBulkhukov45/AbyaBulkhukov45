...
<!-- БЛОК ОБО МНЕ -->
## **Обо мне**
В 2021 году меня вдохновил брат, веб-разработчик. Я начал изучать эту область, пройдя бесплатные курсы и присоединившись к местнему сообществу разработчиков. Там я нашел наставника из [Terra Aries](https://terra-aries.com), который помог мне углубить знания. Затем я присоединился к курсам "Яндекс Практикум - Python Разработчик". Моя учеба продолжается, и я стремлюсь к дальнейшему развитию в веб-разработке.

* 🌍  Сейчас я в Москве
* 💼  В настоящее время я активно участвую в разработке большого группового проекта, связанного с API (на данный момент он является приватным)
